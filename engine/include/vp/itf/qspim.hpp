...
namespace vp {
  ...
  typedef void (qspim_sync_meth_t)(void *, int sck, int data_0, int data_1, int data_2, int data_3);
  typedef void (qspim_sync_cycle_meth_t)(void *, int data_0, int data_1, int data_2, int data_3);
  typedef void (qspim_cs_sync_meth_t)(void *, int cs, int active);

  typedef void (qspim_sync_meth_muxed_t)(void *, int sck, int data_0, int data_1, int data_2, int data_3, int id);
  typedef void (qspim_sync_cycle_meth_muxed_t)(void *, int data_0, int data_1, int data_2, int data_3, int id);
  typedef void (qspim_cs_sync_meth_muxed_t)(void *, int cs, int active, int id);

  typedef void (qspim_slave_sync_meth_t)(void *, int data_0, int data_1, int data_2, int data_3);
  ...
  private:
    ...
    static inline void sync_muxed_stub(qspim_master *_this, int sck, int data_0, int data_1, int data_2, int data_3);
    static inline void sync_cycle_muxed_stub(qspim_master *_this, int data_0, int data_1, int data_2, int data_3);
    static inline void cs_sync_muxed_stub(qspim_master *_this, int cs, int active);

    void (*slave_sync)(void *comp, int data_0, int data_1, int data_2, int data_3);

    void (*sync_meth)(void *, int sck, int data_0, int data_1, int data_2, int data_3);
    void (*sync_meth_mux)(void *, int sck, int data_0, int data_1, int data_2, int data_3, int mux);
    void (*sync_cycle_meth)(void *, int data_0, int data_1, int data_2, int data_3);
    void (*sync_cycle_meth_mux)(void *, int data_0, int data_1, int data_2, int data_3, int mux);
    void (*cs_sync_meth)(void *, int cs, int active);
    void (*cs_sync_meth_mux)(void *, int cs, int active, int mux);

    static inline void sync_default(void *, int data_0, int data_1, int data_2, int data_3);
  ...
  private:
    ...
    void (*slave_sync_meth)(void *, int data_0, int data_1, int data_2, int data_3);

    void (*sync_meth)(void *comp, int sck, int data_0, int data_1, int data_2, int data_3);
    void (*sync_mux_meth)(void *comp, int sck, int data_0, int data_1, int data_2, int data_3, int mux);
    void (*sync_cycle_meth)(void *comp, int data_0, int data_1, int data_2, int data_3);
    void (*sync_cycle_mux_meth)(void *comp, int data_0, int data_1, int data_2, int data_3, int mux);
    void (*cs_sync)(void *comp, int cs, int active);
    void (*cs_sync_mux)(void *comp, int cs, int active, int mux);

    static inline void sync_default(qspim_slave *, int sck, int data_0, int data_1, int data_2, int data_3);
    static inline void sync_cycle_default(qspim_slave *, int data_0, int data_1, int data_2, int data_3);
  ...
  inline void qspim_master::sync_muxed_stub(qspim_master *_this, int sck, int data_0, int data_1, int data_2, int data_3)
  {
    return _this->sync_meth_mux(_this->comp_mux, sck, data_0, data_1, data_2, data_3, _this->sync_mux);
  }



  inline void qspim_master::sync_cycle_muxed_stub(qspim_master *_this, int data_0, int data_1, int data_2, int data_3)
  {
    return _this->sync_cycle_meth_mux(_this->comp_mux, data_0, data_1, data_2, data_3, _this->sync_mux);
  }
  ...
  inline void qspim_master::bind_to(cm::port *_port, cm::config *config)
  {
  ...
  inline void qspim_master::sync_default(void *, int data_0, int data_1, int data_2, int data_3)
  {
  }

  inline void qspim_slave::bind_to(cm::port *_port, cm::config *config)
  {
  ...
  inline void qspim_slave::sync_default(qspim_slave *, int sck, int data_0, int data_1, int data_2, int data_3)
  {
  }

  inline void qspim_slave::sync_cycle_default(qspim_slave *, int data_0, int data_1, int data_2, int data_3)
  {
  }
