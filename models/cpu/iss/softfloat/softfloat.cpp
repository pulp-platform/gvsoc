...
| and exception flags.
*----------------------------------------------------------------------------*/
int8 float_rounding_mode = float_round_to_zero;
...
float32 float32_sgnj( float32 a, float32 b )
{
    flag bSign;
    int16 aExp;
    bits32 aSig;
    ...
    return packFloat32(bSign, aExp, aSig);
}

float32 float32_sgnjn( float32 a, float32 b )
{
    flag bSign;
    int16 aExp;
    bits32 aSig;
    ...
    if (bSign) return packFloat32(0, aExp, aSig);
    else return packFloat32(1, aExp, aSig);
}

float32 float32_sgnjx( float32 a, float32 b )
{
    flag aSign, bSign;
    int16 aExp;
    bits32 aSig;
    ...
    return packFloat32(aSign ^ bSign, aExp, aSig);
}

float32 float32_min( float32 a, float32 b )
{
    if (float32_lt(a, b)) return a;
    else return b;
}

float32 float32_max( float32 a, float32 b )
{
    if (float32_lt(a, b)) return b;
    else return a;
}
