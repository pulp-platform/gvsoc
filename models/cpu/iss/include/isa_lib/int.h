...
//VEC_EXPR_NN_SHIFT_SC(SRL, uint32_t, uint4_t, 1, 8, 0, uint8_t, >>)
VEC_EXPR_NN_SHIFT(SRL, uint32_t, uint2_t, 1, 16, 0, uint8_t, >>)
//VEC_EXPR_NN_SHIFT_SC(SRL, uint32_t, uint2_t, 1, 16, 0, uint8_t, >>)

VEC_EXPR_NN_SHIFT(SRA, int32_t, int4_t, 1, 8, 1, int8_t, >>)
//VEC_EXPR_NN_SHIFT_SC(SRA, int32_t, int4_t, 1, 8, 1, int8_t, >>)
VEC_EXPR_NN_SHIFT(SRA, int32_t, int2_t, 1, 16, 1, int8_t, >>)
//VEC_EXPR_NN_SHIFT_SC(SRA, int32_t, int2_t, 1, 16, 1, int8_t, >>)

VEC_EXPR_NN_SHIFT(SLL, uint32_t, uint4_t, 1, 8, 0, uint8_t, <<)
//VEC_EXPR_NN_SHIFT_SC(SLL, uint32_t, uint4_t, 1, 8, 0, uint8_t, <<)
VEC_EXPR_NN_SHIFT(SLL, uint32_t, uint2_t, 1, 16, 0, uint8_t, <<)
//VEC_EXPR_NN_SHIFT_SC(SLL, uint32_t, uint2_t, 1, 16, 0, uint8_t, <<)
