...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 16, REG_GET(1) >> 16, 5, 10)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 16, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 16, REG_GET(1) >> 16, 5, 10)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 16, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 16, REG_GET(1) >> 16, 5, 10)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 16, REG_GET(1) & 0xffff, 5, 10)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 16, REG_GET(1) >> 16, 8, 7)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 16, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 16, REG_GET(1) >> 16, 8, 7)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 16, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 16, REG_GET(1) >> 16, 8, 7)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) & 0xffff, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 16, REG_GET(1) & 0xffff, 8, 7)==0) & 0xffff) << 16));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) & 0xff, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 8, REG_GET(1) >> 8, 5, 2)==0) & 0xff) << 8) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 16, REG_GET(1) >> 16, 5, 2)==0) & 0xff) << 16) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 24, REG_GET(1) >> 24, 5, 2)==0) & 0xff) << 24));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) & 0xff, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 8, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 8) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 16, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 16) |\
            (((LIB_FF_CALL2(lib_flexfloat_eq, REG_GET(0) >> 24, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 24));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) & 0xff, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 8, REG_GET(1) >> 8, 5, 2)==0) & 0xff) << 8) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 16, REG_GET(1) >> 16, 5, 2)==0) & 0xff) << 16) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 24, REG_GET(1) >> 24, 5, 2)==0) & 0xff) << 24));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) & 0xff, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 8, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 8) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 16, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 16) |\
            (((LIB_FF_CALL2(lib_flexfloat_lt, REG_GET(0) >> 24, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 24));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) & 0xff, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 8, REG_GET(1) >> 8, 5, 2)==0) & 0xff) << 8) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 16, REG_GET(1) >> 16, 5, 2)==0) & 0xff) << 16) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 24, REG_GET(1) >> 24, 5, 2)==0) & 0xff) << 24));
  return insn->next;
}
...
{
  REG_SET(0, ((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) & 0xff, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 8, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 8) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 16, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 16) |\
            (((LIB_FF_CALL2(lib_flexfloat_le, REG_GET(0) >> 24, REG_GET(1) & 0xff, 5, 2)==0) & 0xff) << 24));
  return insn->next;
}
